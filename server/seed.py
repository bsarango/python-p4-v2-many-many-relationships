...
with app.app_context():
    ...
    db.session.query(employee_meetings).delete() #must be deleted via query since its not a model
    db.session.commit() #must use to commit delete to db/ unlike models
